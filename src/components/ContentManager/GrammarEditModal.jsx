                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3">
                                ...
                                <div class="col-6">
                                    <button type="button" onClick={() => { if (!validateAll()) return; else document.getElementById("btn-save-hide-edit-grammar").click() }} class="btn btn-primary w-100">
                                        Lưu thay đổi
                                    </button>
                                    <button type="button" class="d-none" id="btn-save-hide-edit-grammar" data-bs-toggle="modal" data-bs-target="#ViewConfirmEditModal"></button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="ViewConfirmEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Bạn có chắc muốn chỉnh sửa ngữ pháp này chứ ?
                        </div>
